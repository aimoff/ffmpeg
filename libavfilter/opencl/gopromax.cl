                                       ...
                                       __read_only  image2d_t rear)
{
    ...
    if (xy.y < half_height) {
        val = read_imagef(front, sampler, xy);
    } else {
        val = read_imagef(rear, sampler, (int2)(xy.x, (xy.y - half_height)));
    }
                             ...
                             __read_only  image2d_t rear)
{
    ...
    if (loc.y < half_height) {
        val = read_imagef(front, sampler, (int2)(x, loc.y));
    } else {
        val = read_imagef(rear, sampler, (int2)(x, loc.y - half_height));
    }
